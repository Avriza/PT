...
<body>
		...
		<div id="search">
			<div id="search-cont">
				...
				<form method="post">
					...
					<button type="submit" role="button" href="homesearch.php" class="submit"><i class="fa fa-arrow-right"></i></button>
				</form>
			</div>
		</div>
		<ul>
	...
	<?php
		$search=$_POST['search'];
		$sql="Select * from event where nama_acara='$search'";
		$res=$conn->query($sql);
		$jum=0;
							...
							<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							  ...
							  <div class="panel panel-default">
							    <div class="three" role="tab" id="headingThree">
							      <h4 class="panel-title" style="text-align:center">
							        <a charset="">lass="collapsed buy" role="button" data-toggle="modal" data-parent="#accordion" href=".bs-example-modal-sm1<?php echo $jum; ?>" aria-expanded="false" aria-controls="collapseThree">
